...
settings.schema = {
    ...
    },
    {
        ...
        items = {
            ...
            { id = "mouseReturn", name = "Stick self-centring", type = "number", default = 0,
              min = 0, max = 8, step = 0.5, format = "%.1f",
              help = "How fast the mouse stick returns to the middle on its own. Zero holds the deflection, which is what a stick does." },
