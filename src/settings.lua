...
settings.schema = {
    ...
    },
    {
        ...
        items = {
            ...
            { id = "mouseSensitivity", name = "Look sensitivity", type = "number",
              default = 0.055, min = 0.01, max = 0.20, step = 0.005, format = "%.3f",
              help = "How fast the view turns on foot." },
            { id = "stickRange", name = "Mouse travel for full turn", type = "number",
              default = 320, min = 120, max = 800, step = 20, format = "%.0f",
              help = "Pixels of mouse movement that deflect the flight stick fully. Lower is twitchier." },
            { id = "invertY", name = "Invert pitch", type = "bool", default = false },
            { id = "mouseReturn", name = "Stick self-centring", type = "number", default = 3,
              min = 0, max = 8, step = 0.5, format = "%.1f",
              help = "How fast the mouse stick returns to the middle on its own, so the ship settles when your hand stops. Zero holds the deflection, which is what a real stick does." },
            { id = "travelAssist", name = "Travel assist", type = "bool", default = true,
              help = "In cruise with a target selected, holds the speed that arrives at it and drops out on arrival." },
            ...
            { id = "autoScan", name = "Automatic scanning", type = "bool", default = true,
              help = "Holding a target in the reticle scans it, instead of a key." },
            { id = "autoShieldCell", name = "Automatic shield cells", type = "bool", default = true,
              help = "Fires a cell when the shield is about to fail." },
...
settings.quality = {
    potato = {
        ...
        scatter = false, nebula = 0.35, settlementRange = 20000, maxNpcs = 4,
        engineGlows = false,
    ...
    low = {
        ...
        scatter = false, nebula = 0.7, settlementRange = 35000, maxNpcs = 7,
        engineGlows = true,
    ...
    medium = {
        ...
        scatter = true, nebula = 1.0, settlementRange = 60000, maxNpcs = 11,
        engineGlows = true,
    ...
    high = {
        ...
        scatter = true, nebula = 1.0, settlementRange = 90000, maxNpcs = 14,
        engineGlows = true,
